...
You will also need to add a two-way mapping from ShapeShift AssetId <> ramp ticker / ID in the `@xblackfury/caip` package, located in [lib](https://github.com/shapeshift/lib).
